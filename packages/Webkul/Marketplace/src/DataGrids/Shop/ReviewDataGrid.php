        ...
        $this->addColumn([
            ...
            'closure' => function ($row) {
                if ($row->status == 'pending')
                    return '<span class="badge badge-md badge-success">' . trans("marketplace::app.shop.sellers.account.reviews.pending") . '</span>';
                    ...
                    return '<span class="badge badge-md badge-success">' . trans("marketplace::app.shop.sellers.account.reviews.unapproved") . '</span>';
