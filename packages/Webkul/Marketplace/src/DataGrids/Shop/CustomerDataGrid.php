...
class CustomerDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        ...
        ->select('orders.id', 'orders.customer_id',  'marketplace_orders.order_id', DB::raw('sum(marketplace_orders.base_grand_total - marketplace_orders.base_commission) as base_grand_total'), 'marketplace_orders.grand_total', 'marketplace_orders.created_at', 'channel_name', 'orders.status', 'orders.order_currency_code')
        ...
        $this->addFilter('base_grand_total', DB::raw('sum(marketplace_orders.base_grand_total - marketplace_orders.base_commission)'));
