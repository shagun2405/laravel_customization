@if($product->product->type == "booking")
    ...
    @push('scripts')
        ...
        <script type="text/x-template" id="booking-information-template">
            <div>
                ...
                <div class="default-booking-section" v-if="booking.type == 'default'">
                    @include ('marketplace::admin.sellers.products.accordians.booking.default', ['bookingProduct' => $bookingProduct])
                </div>

                <div class="appointment-booking-section" v-if="booking.type == 'appointment'">
                    @include ('marketplace::admin.sellers.products.accordians.booking.appointment', ['bookingProduct' => $bookingProduct])
                </div>

                <div class="event-booking-section" v-if="booking.type == 'event'">
                    @include ('marketplace::admin.sellers.products.accordians.booking.event', ['bookingProduct' => $bookingProduct])
                </div>

                <div class="rental-booking-section" v-if="booking.type == 'rental'">
                    @include ('marketplace::admin.sellers.products.accordians.booking.rental', ['bookingProduct' => $bookingProduct])
                </div>

                <div class="table-booking-section" v-if="booking.type == 'table'">
                    @include ('marketplace::admin.sellers.products.accordians.booking.table', ['bookingProduct' => $bookingProduct])
                </div>
        ...
        @include ('marketplace::admin.sellers.products.accordians.booking.slots')
