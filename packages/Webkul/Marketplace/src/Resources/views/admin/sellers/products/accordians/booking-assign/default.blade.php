    ...
    <script type="text/x-template" id="default-booking-template">
        <div>
            <div class="control-group" :class="[errors.has('booking[booking_type]') ? 'has-error' : '']">
                ...
                <select v-validate="'required'" name="booking[booking_type]" v-model="default_booking.booking_type" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.type') }}&quot;" disabled>
            ...
            <div v-if="default_booking.booking_type == 'many'">
                <div class="control-group" :class="[errors.has('booking[duration]') ? 'has-error' : '']">
                    ...
                    <input type="text" v-validate="'required|min_value:1'" name="booking[duration]" v-model="default_booking.duration" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.slot-duration') }}&quot;" disabled/>
                ...
                <div class="control-group" :class="[errors.has('booking[break_time]') ? 'has-error' : '']">
                    ...
                    <input type="text" v-validate="'required|min_value:1'" name="booking[break_time]" v-model="default_booking.break_time" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.break-time') }}&quot;" disabled/>
                                ...
                                <tr v-for="(day, index) in days">
                                    ...
                                    <td>
                                        <div class="control-group" :class="[errors.has('booking[slots][' + index + '][from]') ? 'has-error' : '']">
                                            <time-component>
                                                <input type="text" v-validate="parseInt(slots.many[index].status) ? 'required': ''" :name="'booking[slots][' + index + '][from]'" class="control" v-model="slots.many[index].from" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.from') }}&quot;" disabled>
                                            </time-component>
                                    ...
                                    <td>
                                        <div class="control-group" :class="[errors.has('booking[slots][' + index + '][to]') ? 'has-error' : '']">
                                            <time-component>
                                                <input type="text" v-validate="parseInt(slots.many[index].status) ? 'required': ''" :name="'booking[slots][' + index + '][to]'" class="control" v-model="slots.many[index].to" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.to') }}&quot;" disabled>
                                            </time-component>
                                    ...
                                    <td>
                                        <div class="control-group" :class="[errors.has('booking[slots][' + index + '][status]') ? 'has-error' : '']">
                                            <select v-validate="'required'" :name="'booking[slots][' + index + '][status]'" class="control" v-model="slots.many[index].status" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.status') }}&quot;" disabled>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <default-slot-item
                                    ...
                                    @onRemoveSlot="removeSlot($event)" disabled>
                                </default-slot-item>

                            </tbody>
                        </table>

                        <button type="button" class="btn btn-lg btn-primary" style="margin-top: 20px" @click="addSlot()" disabled>
        ...
        <tr>
            <td class="has-control-group">
                <div class="control-group" :class="[errors.has(controlName + '[from_day]') ? 'has-error' : '']">
                    <select v-validate="'required'" :name="controlName + '[from_day]'" v-model="slotItem.from_day" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.day') }}&quot;" disabled>
                ...
                <div class="control-group date" :class="[errors.has(controlName + '[from]') ? 'has-error' : '']">
                    <time-component>
                        <input type="text" v-validate="'required'" :name="controlName + '[from]'" v-model="slotItem.from" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.from') }}&quot;" disabled>
                    </time-component>
            ...
            <td class="has-control-group">
                <div class="control-group" :class="[errors.has(controlName + '[to_day]') ? 'has-error' : '']">
                    <select v-validate="'required'" :name="controlName + '[to_day]'" v-model="slotItem.to_day" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.day') }}&quot;" disabled>
                        <option v-for="(day, index) in $parent.days" :value="index">@{{ day }}</option>
                    </select>
                ...
                <div class="control-group date" :class="[errors.has(controlName + '[to]') ? 'has-error' : '']">
                    <time-component>
                        <input type="text" v-validate="'required'" :name="controlName + '[to]'" v-model="slotItem.to" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.to') }}&quot;" disabled>
                    </time-component>
            ...
            <td>
                <i class="icon remove-icon" @click="removeSlot()" disabled></i>
            </td>
        </tr>
    </script>
