...
<div class="content" style="margin-left: 20px; margin-right: 20px;">
        ...
        <form method="POST" action="" enctype="multipart/form-data" @submit.prevent="onSubmit" class="account-table-content">
            ...
            <div class="account-table-content">
                ...
                @if (! in_array( $product->product->type, $allowInventory ) && $product->product->type != 'downloadable')
                ...
                @if ($product->product->type == 'downloadable')
                    @include('marketplace::admin.sellers.products.accordians.downloadable', ['product' => $product->product])
                @endif
            ...
            {!! view_render_event('marketplace.sellers.account.catalog.product.edit-assign.after',compact('product')) !!}
            ...
            <tr>
                ...
                <td data-value="{{ __('admin::app.catalog.products.price') }}">
                    <div class="control-group" :class="[errors.has(variantInputName + '[price]') ? 'has-error' : '']">
                        <input type="text" v-validate="'required'" :name="[variantInputName + '[price]']" :value="price" class="control"  data-vv-as="&quot;{{ __('admin::app.catalog.products.price') }}&quot;" :disabled="!selected_variant"/>
