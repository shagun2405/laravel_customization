        ...
        <div class="slot-list table" v-else>
            <accordian
                ...
                <div slot="body">
                    ...
                    <button type="button" class="btn btn-lg btn-primary" style="margin-top: 20px" @click="addSlot(dayIndex)" disabled>
                        {{ __('bookingproduct::app.admin.catalog.products.add-slot') }}
                    </button>
                </div>
            </accordian>
    ...
    <tr>
        ...
        <td>
            <div class="control-group date" :class="[errors.has(controlName + '[to]') ? 'has-error' : '']">
                <time-component>
                    <input type="text" v-validate="{required: true, time_min: slotItem.from }" :name="controlName + '[to]'" v-model="slotItem.to" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.to') }}&quot;" disabled>
                </time-component>
