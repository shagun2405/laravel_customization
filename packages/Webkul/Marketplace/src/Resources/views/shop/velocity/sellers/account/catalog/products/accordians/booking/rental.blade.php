    ...
    <script type="text/x-template" id="rental-booking-template">
        <div>
            <div class="form-group" :class="[errors.has('booking[renting_type]') ? 'has-error' : '']">
                ...
                <select v-validate="'required'" name="booking[renting_type]" v-model="rental_booking.renting_type" class="form-style" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.renting-type') }}&quot;">
            ...
            <div v-if="rental_booking.renting_type == 'daily' || rental_booking.renting_type == 'daily_hourly'">            
                <div class="form-group" :class="[errors.has('booking[daily_price]') ? 'has-error' : '']">
                    ...
                    <input type="text" v-validate="'required'" name="booking[daily_price]" v-model="rental_booking.daily_price" class="form-style" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.daily-price') }}&quot;"/>
            ...
            <div v-if="rental_booking.renting_type == 'hourly' || rental_booking.renting_type == 'daily_hourly'">            
                <div class="form-group" :class="[errors.has('booking[hourly_price]') ? 'has-error' : '']">
                    ...
                    <input type="text" v-validate="'required'" name="booking[hourly_price]" v-model="rental_booking.hourly_price" class="form-style" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.hourly-price') }}&quot;"/>
            ...
            <div v-if="rental_booking.renting_type == 'hourly' || rental_booking.renting_type == 'daily_hourly'">
                <div class="form-group" :class="[errors.has('booking[same_slot_all_days]') ? 'has-error' : '']">
                    ...
                    <select v-validate="'required'" name="booking[same_slot_all_days]" v-model="rental_booking.same_slot_all_days" class="form-style" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.same-slot-all-days') }}&quot;">
