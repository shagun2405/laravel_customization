            ...
            <div class="grouped-product-list">
                <ul type="none">
                    ...
                    @foreach ($product->groupedProductsBySortOrder as $groupedProduct)
                        @php 
                            $sellerProductPrice = \DB::table('mp_grouped_product_price')->where('product_grouped_product_id',$groupedProduct->id)->first();
                                ...
                                <span class="name">
                                    ...
                                    @include ('shop::seller-group-products.price',
                                            ['product' => $groupedProduct->associated_product, 
                                             'associatePrice'=>$sellerProductPrice->seller_sell_price ??  $groupedProduct->associated_product->price,
                                            ])
                                </span>
                                <span class="qty">
                                    <quantity-changer
