            ...
            <div>
                ...
                <div v-if="! parseInt(booking.available_every_week)">
                    <div class="form-group date" :class="[errors.has('booking[available_from]') ? 'has-error' : '']">
                        ...
                        <datetime>
                            <input type="text" v-validate="'required|date_format:yyyy-MM-dd HH:mm:ss|after:{{\Carbon\Carbon::yesterday()->format('Y-m-d 23:59:59')}}'" name="booking[available_from]" v-model="booking.available_from" class="form-style" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.available-from') }}&quot;" ref="available_from"/>
                        </datetime>
                    ...
                    <div class="form-group date" :class="[errors.has('booking[available_to]') ? 'has-error' : '']">
                        ...
                        <datetime>
                            <input type="text" v-validate="'required|date_format:yyyy-MM-dd HH:mm:ss|after:available_from'" name="booking[available_to]" v-model="booking.available_to" class="form-style" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.available-to') }}&quot;" ref="available_to"/>
                        </datetime>
