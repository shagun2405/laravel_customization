        ...
        <div class="seller-info" style="margin-bottom: 10px;">
            ...
            {!!
                __('marketplace::app.shop.products.sold-by', [
                        'url' => "<a style='color:#007bff !important' href=" . route('marketplace.seller.show', $seller->url) . ">" . $seller->shop_title . " [<i class='material-icons' style='width:12px;font-size:10px'>star_rate</i>" . $reviewRepository->getAverageRating($seller) . "]</a>"
                    ])
            !!}
