@if ($product->product->type == 'bundle')
    ...
    @push('scripts')
        <script type="text/x-template" id="bandle-product-header-template">
            <div>
                <div v-on:click="isHidden = !isHidden" style="cursor:pointer">
                    <h5 style="margin-top: 15px; font-weight:600;"> 
                        {{ __('marketplace::app.shop.sellers.account.catalog.products.bundle_product') }}
                    </h5>
                    <hr />
                </div>
                <div id="bundle-products-div" v-if="isHidden">
                    <div class="accordian-main">
                        <div id="bundleProductDiv" v-for="(bundleItem , bundleItemIndex) in  bundleItemArr">
                            ...
                            <div slot="body" v-bind:style="{display:bundleItem.display}" >
                                <bandle-product-section :bundleitem="bundleItem" :bundleitemindex="bundleItemIndex"></bandle-product-section>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <select id="color" 
                        ...
                        aria-invalid="false" disabled>
                            <option :value="name"  
                                v-for="(inputType, name) in inputTypes">@{{ inputType }}
                            </option>
                    </select>
                </div>
                    ...
                    <select :name="bundleitemName(bundleitemindex,'is_required')"
                        ...
                        aria-invalid="false" disabled>
                            <option :value="isrequiredName"  
                                v-for="(isRequired, isrequiredName) in isRequireds">@{{ isRequired }}
                            </option>
                    </select>
                </div>
                                    ...
                                    <td>
                                        <div class="control-group" :class="[errors.has(inputName(bundleOption) + '[quantity]') ? 'has-error' : '']">
                                            <input type="number" 
                                                ...
                                                class="control" 
                                                data-vv-as="&quot;{{ __('admin::app.catalog.products.quantity') }}&quot;" disabled/>
                                    ...
                                    <td>
                                        <div class="control-group" 
                                            ...
                                            <input type="number" 
                                                    ...
                                                    class="control" 
                                                    data-vv-as="&quot;{{ __('admin::app.catalog.products.sort-order') }}&quot;" disabled/>
                                            <span class="control-error" 
                ...
                methods: {
                    ...
                    getBundleProductItem:function(){
                        ...
                        .then(function(response) {
                            console.log("Bundle Products App")
