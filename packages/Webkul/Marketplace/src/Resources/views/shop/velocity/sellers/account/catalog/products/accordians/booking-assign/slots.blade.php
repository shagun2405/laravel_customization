    ...
    <tr>
        ...
        <td>
            <div class="form-group date" :class="[errors.has(controlName + '[to]') ? 'has-error' : '']">
                <time-component>
                    <input type="text" v-validate="{required: true, time_min: slotItem.from }" :name="controlName + '[to]'" v-model="slotItem.to" class="form-style" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.to') }}&quot;" disabled>
                </time-component>
...
<script>
    ...
    Vue.component('slot-item', {
        ...
        mounted: function() {
            this.$validator.extend('time_min', {
                getMessage: (field) => {
