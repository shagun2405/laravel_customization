<accordian :title="'{{ __('admin::app.catalog.products.images') }}'" :active="false">
    <div slot="header">
        {{ __('admin::app.catalog.products.images') }}
    ...
    <div slot="body">
        ...
        <div class="control-group {!! $errors->has('images.*') ? 'has-error' : '' !!}">
            ...
            <image-wrapper :button-label="'{{ __('admin::app.catalog.products.add-image-btn-title') }}'" input-name="images[files]" :images='@json($product->images)'></image-wrapper>
