        ...
        <script type="text/x-template" id="booking-information-template">
            <div>
                <div class="control-group" :class="[errors.has('booking[type]') ? 'has-error' : '']">
                    ...
                    <select v-validate="'required'" name="booking[type]" v-model="booking.type" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.booking-type') }}&quot;" disabled>
                ...
                <div class="control-group">
                    ...
                    <input type="text" name="booking[location]" v-model="booking.location" class="control" disabled/>
                </div>
                ...
                <div class="control-group" :class="[errors.has('booking[qty]') ? 'has-error' : '']" v-if="booking.type == 'default' || booking.type == 'appointment' || booking.type == 'rental'">
                    ...
                    <input type="text" v-validate="'required|numeric|min:0'" name="booking[qty]" v-model="booking.qty" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.qty') }}&quot;" disabled/>
                ...
                <div class="control-group" v-if="booking.type != 'event' && booking.type != 'default'" :class="[errors.has('booking[available_every_week]') ? 'has-error' : '']">
                    ...
                    <select v-validate="'required'" name="booking[available_every_week]" v-model="booking.available_every_week" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.available-every-week') }}&quot;" disabled>
                ...
                <div v-if="! parseInt(booking.available_every_week)">
                    <div class="control-group date" :class="[errors.has('booking[available_from]') ? 'has-error' : '']">
                        ...
                        <datetime>
                            <input type="text" v-validate="'required|date_format:yyyy-MM-dd HH:mm:ss|after:{{\Carbon\Carbon::yesterday()->format('Y-m-d 23:59:59')}}'" name="booking[available_from]" v-model="booking.available_from" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.available-from') }}&quot;" ref="available_from" disabled/>
                        </datetime>
                    ...
                    <div class="control-group date" :class="[errors.has('booking[available_to]') ? 'has-error' : '']">
                        ...
                        <datetime>
                            <input type="text" v-validate="'required|date_format:yyyy-MM-dd HH:mm:ss|after:available_from'" name="booking[available_to]" v-model="booking.available_to" class="control" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.available-to') }}&quot;" ref="available_to" disabled/>
                        </datetime>
