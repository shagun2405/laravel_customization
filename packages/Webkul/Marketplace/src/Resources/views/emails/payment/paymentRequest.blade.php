    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            <span style="font-weight: bold;">
                {{ __('marketplace::app.mail.sales.paymentRequest.heading') }}
            </span> <br>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('marketplace::app.mail.sales.paymentRequest.dear', ['name' => $name]) }}
            </p>
                {{ __('marketplace::app.mail.sales.paymentRequest.request', ['seller_name' => $sellerName]) }}
            <p>
