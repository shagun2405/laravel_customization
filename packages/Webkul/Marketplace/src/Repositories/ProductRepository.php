    ...
    public function searchProducts($term)
    {
        $results = app('Webkul\Product\Repositories\ProductFlatRepository')->scopeQuery(function($query) use($term) {
            ...
            if ($mpGlobalAllowedProducts) {
                $mpGlobalAllowedProducts = explode(",", $mpGlobalAllowedProducts);
                // if(in_array('booking', $mpGlobalAllowedProducts)) {
                //     array_push($productType, 'booking');
                // }
                // if(in_array('bundle', $mpGlobalAllowedProducts)) {
                //     array_push($productType, 'bundle');
                // }
                // if(in_array('grouped', $mpGlobalAllowedProducts)) {
