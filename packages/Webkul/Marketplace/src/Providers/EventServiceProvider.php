...
class EventServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        if (core()->getConfigData('marketplace.settings.general.status')) {
            ...
            $mp_product_types = core()->getConfigData('marketplace.products_setting.type.allowed_product');

            if (isset($mp_product_types) && $mp_product_types != null) {
                $mpProductTypes = explode(",", $mp_product_types);
                
                if (in_array('grouped', $mpProductTypes)) {
                ...
                if (in_array('bundle', $mpProductTypes)) {
                ...
                if (in_array('booking', $mpProductTypes)) {
                }
            }
