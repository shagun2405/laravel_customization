<header class="sticky-header">
    <div class="row remove-padding-margin galaxy-divide-page" style="    justify-content: inherit;">
        <a class="left navbar-brand" href="{{ route('shop.home.index') }}" aria-label="Logo">
            <img class="logo" src="{{ core()->getCurrentChannel()->logo_url ?? asset('themes/galaxy/assets/images/logga_svart.png') }}" alt="" />
        </a>

        <div class="galaxy_searchbar">
             @include('galaxy::shop.layouts.particals.search-bar')
        </div>
