<nav class="row" id="top" >
    <div class="col-md-6">
        <nav class="mt-5 sidebar flex-1 flex flex-col divide-y divide-green-900 overflow-y-auto" aria-label="Sidebar">
            <div class="px-2 space-y-1">
                <!-- Current: "bg-cyan-800 text-white", Default: "text-cyan-100 hover:text-white hover:bg-cyan-600" -->
                <a href="#" class="bg-green-900 text-white group flex items-center px-2 py-2 text-md leading-6 font-medium rounded-md mb-2" aria-current="page">
                ...
                <a href="#" class="text-green-900 hover:text-white hover:bg-green-900 group flex items-center px-2 py-2 text-md leading-6 font-medium rounded-md">
