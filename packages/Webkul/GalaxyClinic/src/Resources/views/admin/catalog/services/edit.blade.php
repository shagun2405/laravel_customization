...
@section('page_title')
    {{ __('galaxyclinic::app.catalog.services.edit-title') }}
@stop
...
<div class="content">
        ...
        {!! view_render_event('bagisto.galaxyclinic.catalog.service.edit.before', ['product' => $product]) !!}
            ...
            <div class="page-content">
                ...
                @foreach ($product->attribute_family->attribute_groups as $index => $attributeGroup)
                    ...
                    @if (count($customAttributes))
                        ...
                        {!! view_render_event('bagisto.galaxyclinic.catalog.service.edit_form_accordian.' . $attributeGroup->name . '.before', ['product' => $product]) !!}

                        <accordian title="{{ __($attributeGroup->name) }}"
                                   :active="{{$index == 0 ? 'true' : 'false'}}">
                            <div slot="body">
                                {!! view_render_event('bagisto.galaxyclinic.catalog.service.edit_form_accordian.' . $attributeGroup->name . '.controls.before', ['product' => $product]) !!}
                                ...
                                {!! view_render_event('bagisto.galaxyclinic.catalog.service.edit_form_accordian.' . $attributeGroup->name . '.controls.after', ['product' => $product]) !!}
                            </div>
                        </accordian>

                        {!! view_render_event('bagisto.galaxyclinic.catalog.service.edit_form_accordian.' . $attributeGroup->name . '.after', ['product' => $product]) !!}
                ...
                {!! view_render_event(
                  'bagisto.galaxyclinic.catalog.service.edit_form_accordian.additional_views.before',
                   ['product' => $product])
                !!}
                ...
                {!! view_render_event(
                  'bagisto.galaxyclinic.catalog.service.edit_form_accordian.additional_views.after',
                   ['product' => $product])
                !!}
            </div>
        ...
        {!! view_render_event('bagisto.galaxyclinic.catalog.service.edit.after', ['product' => $product]) !!}
    </div>
@stop
