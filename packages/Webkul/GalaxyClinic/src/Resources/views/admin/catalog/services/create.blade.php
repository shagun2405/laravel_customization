...
@section('page_title')
    {{ __('galaxyclinic::app.catalog.services.add-title') }}
@stop
        ...
        <form method="POST" action="" @submit.prevent="onSubmit">
            <div class="page-header">
                <div class="page-title">
                    <h1>
                        <i class="icon angle-left-icon back-link" onclick="window.location = '{{ route('admin.galaxyclinic.catalog.services.index') }}'"></i>
            ...
            <div class="page-content">
                ...
                {!! view_render_event('bagisto.galaxyclinic.catalog.service.create_form_accordian.general.before') !!}

                <accordian title="{{ __('admin::app.catalog.products.general') }}" :active="true">
                    <div slot="body">
                        {!! view_render_event('bagisto.galaxyclinic.catalog.service.create_form_accordian.general.controls.before') !!}
                        ...
                        <div class="control-group" :class="[errors.has('type') ? 'has-error' : '']">
                            ...
                            <select class="control" v-validate="'required'" id="type" name="type" {{ $familyId ? 'disabled' : '' }} data-vv-as="&quot;{{ __('admin::app.catalog.products.product-type') }}&quot;">
                                ...
                                <option value="booking">
                                    {{ __('admin::app.catalog.products.type.'.strtolower('Booking')) }}
                        ...
                        {!! view_render_event('bagisto.galaxyclinic.catalog.service.create_form_accordian.general.controls.after') !!}
                    </div>
                </accordian>

                {!! view_render_event('bagisto.galaxyclinic.catalog.service.create_form_accordian.general.after') !!}

                @if ($familyId)
                    {!! view_render_event('bagisto.galaxyclinic.catalog.service.create_form_accordian.configurable_attributes.before') !!}

                    <accordian title="{{ __('admin::app.catalog.products.configurable-attributes') }}" :active="true">
                        <div slot="body">
                            {!! view_render_event('bagisto.galaxyclinic.catalog.service.create_form_accordian.configurable_attributes.controls.before') !!}
                            ...
                            {!! view_render_event('bagisto.galaxyclinic.catalog.service.create_form_accordian.configurable_attributes.controls.after') !!}
                        </div>
                    </accordian>

                    {!! view_render_event('bagisto.galaxyclinic.catalog.service.create_form_accordian.configurable_attributes.after') !!}
                @endif
            </div>
        </form>
    </div>
