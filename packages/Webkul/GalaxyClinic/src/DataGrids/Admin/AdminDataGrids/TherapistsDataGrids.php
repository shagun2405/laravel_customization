...
class TherapistsDataGrids extends DataGrid
{
    /**
     * Index.
     *
    ...
    public function prepareQueryBuilder()
    {
        $queryBuilder = DB::table('customers')
            ...
            )->where('customers.customer_group_id', core()->getConfigData('galaxyclinic.settings.general.default_therapists_group'));
    ...
    public function addColumns()
    {
        ...
        $this->addColumn([
            'index' => 'clinic',
            'label' => trans('galaxyclinic::app.catalog.services.clinics'),
            'type' => 'string',
            'searchable' => false,
            'sortable' => false,
            'closure' => function($row) {
                return '<a href = "' . route('admin.galaxyclinic.catalog.therapists.clinics', $row->customer_id) . '" class="btn btn-sm btn-primary pay-btn" name="seller_id" value="' . $row->customer_id .'">' . trans('galaxyclinic::app.catalog.services.add-clinics') . '</a>';
            }
        ]);
    }
    ...
    public function prepareActions()
    {
        $this->addAction([
            'method' => 'GET',
            'route'  => 'admin.galaxyclinic.catalog.therapists.edit',
